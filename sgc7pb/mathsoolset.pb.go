...
var file_mathsoolset_proto_rawDesc = []byte{
...
var (
	...
	file_mathsoolset_proto_rawDescData = file_mathsoolset_proto_rawDesc
)

func file_mathsoolset_proto_rawDescGZIP() []byte {
	file_mathsoolset_proto_rawDescOnce.Do(func() {
		file_mathsoolset_proto_rawDescData = protoimpl.X.CompressGZIP(file_mathsoolset_proto_rawDescData)
	})
	return file_mathsoolset_proto_rawDescData
}

var file_mathsoolset_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_mathsoolset_proto_goTypes = []interface{}{
...
func file_mathsoolset_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_mathsoolset_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mathsoolset_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReplyRunScript); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mathsoolset_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_mathsoolset_proto_rawDesc = nil

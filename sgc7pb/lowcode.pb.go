...
var file_lowcode_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0xe1, 0x04, 0x0a, 0x09, 0x47, 0x61, 0x6d, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x12,
...
var file_lowcode_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_lowcode_proto_goTypes = []interface{}{
	...
	(*GameParam)(nil),                 // 40: sgc7pb.GameParam
	nil,                               // 41: sgc7pb.GameParam.MapComponentsEntry
	nil,                               // 42: sgc7pb.GameParam.MapValsEntry
	nil,                               // 43: sgc7pb.GameParam.MapStrValsEntry
...
var file_lowcode_proto_depIdxs = []int32{
	...
	41, // 38: sgc7pb.GameParam.mapComponents:type_name -> sgc7pb.GameParam.MapComponentsEntry
	42, // 39: sgc7pb.GameParam.mapVals:type_name -> sgc7pb.GameParam.MapValsEntry
	43, // 40: sgc7pb.GameParam.mapStrVals:type_name -> sgc7pb.GameParam.MapStrValsEntry
	44, // 41: sgc7pb.GameParam.MapComponentsEntry.value:type_name -> google.protobuf.Any
...
func file_lowcode_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_lowcode_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
		...
		file_lowcode_proto_msgTypes[37].Exporter = func(v interface{}, i int) interface{} {
		...
		file_lowcode_proto_msgTypes[38].Exporter = func(v interface{}, i int) interface{} {
		...
		file_lowcode_proto_msgTypes[39].Exporter = func(v interface{}, i int) interface{} {
		...
		file_lowcode_proto_msgTypes[40].Exporter = func(v interface{}, i int) interface{} {

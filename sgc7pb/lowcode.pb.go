...
var file_lowcode_proto_rawDesc = []byte{
	...
	0x6e, 0x65, 0x6e, 0x74, 0x22, 0x8f, 0x02, 0x0a, 0x09, 0x47, 0x61, 0x6d, 0x65, 0x50, 0x61, 0x72,
...
var file_lowcode_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_lowcode_proto_goTypes = []interface{}{
	...
	(*GameParam)(nil),             // 9: sgc7pb.GameParam
	nil,                           // 10: sgc7pb.GameParam.MapComponentsEntry
...
var file_lowcode_proto_depIdxs = []int32{
	...
	10, // 7: sgc7pb.GameParam.mapComponents:type_name -> sgc7pb.GameParam.MapComponentsEntry
	11, // 8: sgc7pb.GameParam.MapComponentsEntry.value:type_name -> google.protobuf.Any

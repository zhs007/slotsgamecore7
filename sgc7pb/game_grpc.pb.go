...
type DTGameLogicClient interface {
	...
	// play - play game
	Play(ctx context.Context, in *RequestPlay, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ReplyPlay], error)
	// play2 - play game v2
...
func (c *dTGameLogicClient) Play(ctx context.Context, in *RequestPlay, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ReplyPlay], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &DTGameLogic_ServiceDesc.Streams[0], DTGameLogic_Play_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[RequestPlay, ReplyPlay]{ClientStream: stream}
...
type DTGameLogic_PlayClient = grpc.ServerStreamingClient[ReplyPlay]
...
type DTGameLogicServer interface {
	...
	// play - play game
	Play(*RequestPlay, grpc.ServerStreamingServer[ReplyPlay]) error
	// play2 - play game v2
	Play2(context.Context, *RequestPlay) (*ReplyPlay, error)
	mustEmbedUnimplementedDTGameLogicServer()
}

// UnimplementedDTGameLogicServer must be embedded to have
...
func (UnimplementedDTGameLogicServer) Play(*RequestPlay, grpc.ServerStreamingServer[ReplyPlay]) error {
...
func (UnimplementedDTGameLogicServer) testEmbeddedByValue()                     {}
...
func RegisterDTGameLogicServer(s grpc.ServiceRegistrar, srv DTGameLogicServer) {
	// If the following call pancis, it indicates UnimplementedDTGameLogicServer was
...
func _DTGameLogic_Play_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DTGameLogicServer).Play(m, &grpc.GenericServerStream[RequestPlay, ReplyPlay]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type DTGameLogic_PlayServer = grpc.ServerStreamingServer[ReplyPlay]
...
func (c *gameLogicClient) Play(ctx context.Context, in *RequestPlay, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ReplyPlay], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GameLogic_PlayClient = grpc.ServerStreamingClient[ReplyPlay]
...
func (UnimplementedGameLogicServer) Play(*RequestPlay, grpc.ServerStreamingServer[ReplyPlay]) error {
	return status.Errorf(codes.Unimplemented, "method Play not implemented")
}
...
func RegisterGameLogicServer(s grpc.ServiceRegistrar, srv GameLogicServer) {
	// If the following call pancis, it indicates UnimplementedGameLogicServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _GameLogic_Play_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GameLogicServer).Play(m, &grpc.GenericServerStream[RequestPlay, ReplyPlay]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GameLogic_PlayServer = grpc.ServerStreamingServer[ReplyPlay]

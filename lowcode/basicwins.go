...
// 	gs := basicWins.GetTargetScene3(gameProp, curpr, prs, &bwd.BasicComponentData, basicWins.Name, tf.TargetScene, 0)
...
// 	gs := basicWins.GetTargetScene3(gameProp, curpr, prs, &bwd.BasicComponentData, basicWins.Name, "", 0)

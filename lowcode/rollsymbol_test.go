...
func (c *cbSymbolsCD) Clone() IComponentData {
	return &cbSymbolsCD{symbols: append([]int{}, c.symbols...)}
}
...
func (c *cbSymbolsCD) AddSymbolCodes(symbolCodes []int)   {}
func (c *cbSymbolsCD) ClearSymbolCodes()                  {}

type cbSymbolsComp struct {
	name string
	syms []int
}
...
func (c *cbSymbolsComp) OnAsciiGame(gameProp *GameProperty, pr *sgc7game.PlayResult, lst []*sgc7game.PlayResult, mapSymbolColor *asciigame.SymbolColorMap, cd IComponentData) error {
	return nil
}
func (c *cbSymbolsComp) NewComponentData() IComponentData {
	return &cbSymbolsCD{symbols: append([]int{}, c.syms...)}
}
func (c *cbSymbolsComp) EachUsedResults(pr *sgc7game.PlayResult, pbComponentData *anypb.Any, oneach FuncOnEachUsedResult) {
}
func (c *cbSymbolsComp) ProcRespinOnStepEnd(gameProp *GameProperty, curpr *sgc7game.PlayResult, gp *GameParams, cd IComponentData, canRemove bool) (string, error) {
	return "", nil
}
...
func (c *cbSymbolsComp) CanTriggerWithScene(gameProp *GameProperty, gs *sgc7game.GameScene, curpr *sgc7game.PlayResult, stake *sgc7game.Stake, icd IComponentData) (bool, []*sgc7game.Result) {
	return false, nil
}
...
func (c *cbSymbolsComp) SetMask(plugin sgc7plugin.IPlugin, gameProp *GameProperty, curpr *sgc7game.PlayResult, gp *GameParams, cd IComponentData, mask []bool) error {
	return nil
}
func (c *cbSymbolsComp) SetMaskVal(plugin sgc7plugin.IPlugin, gameProp *GameProperty, curpr *sgc7game.PlayResult, gp *GameParams, cd IComponentData, index int, mask bool) error {
	return nil
}
func (c *cbSymbolsComp) SetMaskOnlyTrue(plugin sgc7plugin.IPlugin, gameProp *GameProperty, curpr *sgc7game.PlayResult, gp *GameParams, cd IComponentData, mask []bool) error {
	return nil
}
func (c *cbSymbolsComp) EachSymbols(gameProp *GameProperty, curpr *sgc7game.PlayResult, gp *GameParams, plugin sgc7plugin.IPlugin, ps sgc7game.IPlayerState, stake *sgc7game.Stake, prs []*sgc7game.PlayResult, cd IComponentData) error {
	return nil
}
...
func (c *cbSymbolsComp) InitPlayerState(pool *GamePropertyPool, gameProp *GameProperty, plugin sgc7plugin.IPlugin, ps *PlayerState, betMethod int, bet int) error {
	return nil
}
...
func (p *fakePluginErrLocal) Random(_ context.Context, r int) (int, error) {
	return 0, fmt.Errorf("rnderr")
}

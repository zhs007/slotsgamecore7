...
// CanTrigger -
func (scatterTrigger *ScatterTrigger) canTrigger(gameProp *GameProperty, gs *sgc7game.GameScene, curpr *sgc7game.PlayResult, stake *sgc7game.Stake, isSaveResult bool, symbols []int) (bool, []*sgc7game.Result) {
	isTrigger := false
	lst := []*sgc7game.Result{}
